...
<section class="home-section p-3">
  ...
  <div id="content-area" class="container mt-5">
    ...
    <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#registrarCajaModal">Registrar Caja</button>
...
<%--            <button class="btn btn-danger">Eliminar</button>--%>
    ...
    <div class="modal fade" id="registrarCajaModal" tabindex="-1" role="dialog" aria-labelledby="registrarCajaModalLabel" aria-hidden="true">
...
<%--                  <option value="ocupada">Ocupada</option>--%>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="saldoInicial" name="saldoInicial" step="0.01" value="0.00" required>
              </div>

              <div class="form-group">
                <label for="saldoFinal">Saldo Final:</label>
                <input type="number" class="form-control" id="saldoFinal" name="saldoFinal" step="0.01" value="0.00">
              </div>
            </div>
